    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex items-center justify-between h-16">
        ...
        <div class="hidden md:flex items-center space-x-4">
          ...
          <a href="https://github.com/The-Andb/andb-desktop/releases/tag/v4.0.2" target="_blank" class="bg-blue-600 hover:bg-blue-500 text-white px-4 py-2 rounded-lg text-sm font-medium transition-colors shadow-[0_4px_14px_0_rgba(37,99,235,0.39)]">
            Download Beta
          </a>
        </div>
      </div>
