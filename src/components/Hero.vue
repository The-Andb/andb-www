<template>
  <section class="relative pt-32 pb-16 lg:pt-48 lg:pb-24">
    ...
    <div class="container mx-auto px-4 text-center z-10">
      <!-- Badge -->
      <a href="https://github.com/The-Andb/andb-desktop/releases/tag/v3.3.5" target="_blank" class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-50 dark:bg-white/5 border border-blue-200 dark:border-white/10 text-xs font-medium text-blue-600 dark:text-blue-400 hover:bg-blue-100 dark:hover:bg-white/10 transition mb-4 animate-fade-in-up">
      ...
      <div class="flex flex-col sm:flex-row items-center gap-4 justify-center animate-fade-in-up delay-200">
        <a href="https://github.com/The-Andb/andb-desktop/releases/tag/v3.3.5" target="_blank" class="px-8 py-3.5 bg-blue-600 hover:bg-blue-500 text-white rounded-lg font-semibold shadow-lg shadow-blue-500/25 transition-all hover:scale-105 active:scale-95 flex items-center gap-2">
          <span>Download Beta <span class="opacity-70 text-sm font-normal">v3.3.5</span></span>
