  ...
  <section class="py-20 relative text-center" id="download">
    ...
    <div class="max-w-2xl mx-auto px-4">
      ...
      <div class="flex flex-col sm:flex-row gap-4 justify-center">
        <a href="https://github.com/The-Andb/andb-desktop/releases/tag/v4.0.1" target="_blank" class="block w-full sm:w-auto px-6 py-4 bg-gray-900 dark:bg-white hover:bg-black dark:hover:bg-gray-100 text-white dark:text-black rounded-xl font-bold transition-all hover:scale-105 active:scale-95 shadow-xl shadow-gray-900/20 dark:shadow-white/5 cursor-pointer">
          Download for macOS
          <span class="block text-xs font-normal text-gray-400 dark:text-gray-500 mt-1">Apple Silicon & Intel</span>
        </a>
        <a href="https://github.com/The-Andb/andb-desktop/releases/tag/v4.0.1" target="_blank" class="block w-full sm:w-auto px-6 py-4 bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 text-gray-900 dark:text-white rounded-xl font-bold transition-all border border-gray-300 dark:border-gray-700 cursor-pointer">
           Download for Linux
          <span class="block text-xs font-normal text-gray-500 mt-1">AppImage & .deb</span>
        </a>
      ...
      <!-- macOS Fix Section -->
      <div class="mt-16 grid grid-cols-1 md:grid-cols-2 gap-6 text-left max-w-4xl mx-auto">
        <!-- Mac Fix -->
